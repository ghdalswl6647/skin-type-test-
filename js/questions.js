...
const TROUBLE_CARE_TIPS = {
  dry: "건성인데 트러블이 나면 피부 장벽이 약해져 있는 경우가 많아요. 보습·진정을 챙기면서 아래 추천 앰플로 트러블 부위만 집중 케어해보세요.",
  oily: "지성 피부는 과다 피지가 트러블의 주 원인이에요. 아래 추천 앰플로 피지 밸런스를 잡아주면서 세안을 놓치지 않는 게 중요해요.",
  combo: "복합성은 T존 위주로 트러블이 나기 쉬워요. 전체가 아니라 트러블 난 부위 위주로 아래 앰플을 발라 국소적으로 케어해보세요.",
  subji: "수부지는 속건조로 인한 피지 과다 분비가 트러블로 이어지기 쉬워요. 속수분을 채우면서 아래 앰플로 트러블 부위를 진정시켜주세요.",
  sensitive: "민감성 피부의 트러블은 자극에 대한 반응인 경우가 많아요. 새 제품을 한꺼번에 바꾸지 말고, 아래 앰플처럼 진정 성분 위주로 최소한만 발라주세요.",
  neutral: "평소엔 트러블이 적은 편인데 요즘 났다면 컨디션 저하나 자극 때문인 경우가 많아요. 아래 앰플로 해당 부위만 가볍게 케어하고 며칠 지켜봐주세요.",
};
